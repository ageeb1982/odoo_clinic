...
class ClinicDoctor(models.Model):
    _name = 'clinic.doctor'
    _description = "لعرض كل بيانات الاطباء"
    ...
    patient_id = fields.One2many(
        'clinic.patient', 'doctor_id', string='المرضى')

    specialty = fields.Many2one('doctor.specialty', string="التخصص")
    academic_degree = fields.Selection(
        [('bachelor', 'بكلاريوس'), ('master', 'ماجستير'), ('phd', 'دكتوراه')], string="الدرجة العلمية")
